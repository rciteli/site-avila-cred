...
export const metadata: Metadata = {
  ...
  description:
    "Fale com um especialista. Análise gratuita e retorno em até 1 dia útil.",
  alternates: { canonical: "/contato" }, // vira absoluto via metadataBase do layout
  openGraph: {
    type: "website",
    url: "/contato",
    siteName: "ÁvilaCred",
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 py-8 md:py-10">
          <div className="mt-3 max-w-3xl">
            ...
            <h1 className="mt-4 text-4xl font-bold leading-tight md:text-5xl text-[#e5e6ff]">
              Entre em contato
            </h1>
            <p className="mt-3 text-[#c6c7db]/85 md:text-[15.5px] ">
              Envie seus dados e receba uma análise gratuita em até{" "}
              <strong>1 dia útil</strong>. Transparência do primeiro contato ao
              pagamento.
            </p>
          </div>
        </div>
          ...
          <div className="grid items-start gap-8 md:grid-cols-[1.2fr_0.8fr]">
            ...
            >
              ...
              <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
                <h2 className="text-xl font-semibold text-[#000030] md:text-2xl">
                  Envie sua mensagem
                </h2>
            ...
            <aside className="space-y-6 rounded-3xl border border-white/10 bg-white/5 p-6 md:p-8">
              <div>
                <h3 className="text-lg font-semibold text-[#e5e6ff]">
                ...
                <ul className="mt-4 space-y-3 text-sm text-white/85">
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      href="mailto:contato@avilacred.com.br"
